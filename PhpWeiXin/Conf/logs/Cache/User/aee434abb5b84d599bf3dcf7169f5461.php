...
<div class="content">
  ...
  <tr>
              		<th>券名称：</th>
              		<td><input type="text" class="px" id="title" value="<?php echo ($vip["title"]); ?>" name="title" style="width:400px;"> </td>
              		</tr>
...
<th>发布有效期：</th>
<td>
	<input type="text" class="px" id="statdate" value="<?php echo (date('Y-m-d',$vip["statdate"])); ?>" onClick="WdatePicker()" name="statdate"> （含）到
	<input type="text" class="px" id="enddate" value="<?php echo (date('Y-m-d',$vip["enddate"])); ?>" name="enddate" onClick="WdatePicker()">（含）
</td>
</tr>
<tr>
    <th>使用有效：</th>
    <td><input type="text" class="px" id="days" value="<?php echo ($vip["days"]); ?>" name="days" style="width:100px;">天（从购买或领取当天算起） </td>
</tr>
 <tr>
    <th>卡余额限制：</th>
    <td><input type="text" class="px" id="balance" value="<?php echo ($vip["balance"]); ?>" name="balance" style="width:100px;">元 </td>
</tr>
<tr>
    <th>优惠券价格：</th>
    <td><input type="text" class="px" id="money" value="<?php echo ($vip["money"]); ?>" name="money" style="width:100px;">元 </td>
</tr>
<tr>
<th>优惠劵属性：</th>
<td height="35">
...
　<label>
    ...
    <label>
        <input type="radio" <?php if($vip['attr'] == '2'): ?>checked="checked"<?php endif; ?> name="attr" class="attr" value="2">
        商品券
    </label>
</td>
</tr>
...
<th>优惠劵图标：</th>
<td>
<img src="<?php if($vip["pic"] == '' and $vip["type"] == 1): ?>/tpl/User/default/common/images/cart_info/youhui.jpg<?php elseif($vip["pic"] == '' and $vip["type"] == 0): ?>/tpl/User/default/common/images/cart_info/daijin.png<?php else: echo ($vip["pic"]); endif; ?>" id="pic_src"style="max-width:200px;"><br/>
<input type="text" name="pic" id="pic" value="<?php if($vip["pic"] == '' and $vip["type"] == 1): ?>/tpl/User/default/common/images/cart_info/youhui.jpg<?php elseif($vip["pic"] == '' and $vip["type"] == 0): ?>/tpl/User/default/common/images/cart_info/daijin.png<?php else: echo ($vip["pic"]); endif; ?>" class="px" style="width:200px;"> 
...
<tr>
    ...
    <td>
        <textarea name="useinfo" id="useinfo" rows="5" style="width: 410px; height: 250px; display: none;"><?php echo ($vip["useinfo"]); ?></textarea>
    </td>
</tr>  
<tr>
<th>数量：</th>
<td>总共：<input type="text" class="px" id="people" value="<?php echo ($vip["people"]); ?>" name="people" style="width:50px;"> 张券</td>
</tr>
<tr>
    <th>多件购买优惠：</th>
    <td height="35">
        <label>
            <input type="radio"<?php if($vip['ischeap'] == '1' or $vip['ischeap'] == ''): ?>checked="checked"<?php endif; ?> name="ischeap" class="ischeap" value="1">
            是
        </label>
        <label>
            <input type="radio"<?php if($vip['ischeap'] == '0'): ?>checked="checked"<?php endif; ?> name="ischeap" class="ischeap" value="0">
            否（一个自然月内购买多件优惠）
        </label>
    </td>
</tr>
<tr class="discount">
    ...
    <td height="35">
        <label>
            <input type="text" class="px" id="discount" value="<?php echo ($vip["discount"]); ?>" name="discount" style="width:100px;">折
        </label>
    </td>                   
</tr>
<tr>
    ...
    <td height="35">
        <label>
            <input type="radio"<?php if($vip['ispublic'] == '1' or $vip['ispublic'] == ''): ?>checked="checked"<?php endif; ?> name="ispublic" class="attr" value="1">
            启用
        </label>
        <label>
            <input type="radio"<?php if($vip['ispublic'] == '0'): ?>checked="checked"<?php endif; ?> name="ispublic" class="attr" value="0">
            不启用
        </label>
    </td>
    </tr>
