...
<td><?php echo ($o["qq"]); ?></td>
<td class="norightborder"><a href="<?php echo U('Vcard/edit',array('id'=>$o['id']));?>">修改</a> <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Vcard/delete',array('id'=>$o['id']));?>');">删除</a> <a href="<?php echo U('Wap/Vcard/index',array('id'=>$o['id'],'token'=>$o['token']));?>" target="_blank">预览</a></td>
