...
<body>
    ...
    <article class="box">
        ...
        <div class="cont">
            <h2>￥<?php echo ($_REQUEST['price']); ?>元</h2>
            <br />
            <form action="#" method="post" name="payform">
                <input type="password" name="pass" class="inp" id="pass" placeholder="支付密码" /><br /><br />
                <?php if($_REQUEST['discount'] != 10): ?><font size='2'>(会员优惠折扣<?php echo ($_REQUEST['discount']); ?>折)</font><?php endif; ?>
            </form>
        </div>
        <footer>
