            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%" >
              ...
              <TBODY>
				 <?php if(is_array($members)): $i = 0; $__LIST__ = $members;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><TR>
                  <TD style='font-size:10px'><?php echo ($list["number"]); ?></TD>
                  <TD style='font-size:10px'><?php echo ($list["wechaname"]); ?></TD>
                  <TD style='font-size:10px'><?php echo ($list["carno"]); ?></TD>
                  <TD style='font-size:10px' ><?php echo ($list["carno1"]); ?></TD>
                  <TD style='font-size:10px'><?php echo ($list["carno2"]); ?></TD>
                  <TD style='font-size:10px'><?php echo ($list["tel"]); ?></TD>
                  ...
                  <TD class="norightborder" style='font-size:12px'>				  
				       <a href="javascript:void(0);" onclick="memberCardRecharge(<?php echo ($list["id"]); ?>,<?php echo ($thisCard["id"]); ?>)"><strong>充值</strong></a>
				       |  
                       <a href="javascript:void(0);" onclick="updateGrade('<?php echo ($list["wecha_id"]); ?>', <?php echo ($thisCard["id"]); ?>, '<?php echo ($list["truename"]); ?>', '<?php echo ($list["carno"]); ?>');"><strong>等级变更</strong></a>
                       |
                       <a href="javascript:void(0);" onclick="memberCardPresent('<?php echo ($list["wecha_id"]); ?>', <?php echo ($thisCard["id"]); ?>, '<?php echo ($list["truename"]); ?>', '<?php echo ($list["carno"]); ?>');"><strong>赠券</strong></a>
                       | 
                      <a href="<?php echo U('Member_card/member',array('token'=>$token,'wecha_id'=>$list['wecha_id'],'id'=>$thisCard['id']));?>"><strong>消费记录</strong></a>
                       |
                      <a href="javascript:void(0);" onclick="RestPassWord('<?php echo ($list["wecha_id"]); ?>');" ><strong>密码重置</strong></a>
				       |
                      ...
                      |
                      <a href="javascript:void(0);" onclick="SendMessage('<?php echo ($list["wecha_id"]); ?>', <?php echo ($thisCard["id"]); ?>, '<?php echo ($list["truename"]); ?>', '<?php echo ($list["carno"]); ?>');"><strong>发送消息</strong></a>
