            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
					...
					<th >标题</th>
					<th class="time">属性</th>
                    <th class="time" style="width:80px;">总数</th>
                    <th class="time" style="width:80px;">已购领数</th>
					<th class="time" style="width:80px;">已使用数</th>
                    <th class="time" style="width:80px;">创建时间</th>
                    <th class="time" style="width:80px;">过期时间</th>
                    <th class="edit norightborder" style="width:180px;">操作</th>
                </tr>
              </thead>
              <tbody>
                <?php if(is_array($data_vip)): $i = 0; $__LIST__ = $data_vip;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data_vip): $mod = ($i % 2 );++$i;?><tr>
					  ...
					  <td>
                       ...
                       <?php elseif($data_vip["attr"] == '2'): ?>
                          商品劵
                        <?php else: ?>
                        普通劵<?php endif; ?>
					  </td>
                      <td><?php echo ($data_vip["people"]); ?></td>
                      <td><?php echo ($data_vip["count"]); ?></td>
					  <td><?php echo ($data_vip["usetime"]); ?></td>
					  <td><?php echo (date('Y-m-d',$data_vip["statdate"])); ?></td>
					  <td><?php echo (date('Y-m-d',$data_vip["enddate"])); ?></td>
