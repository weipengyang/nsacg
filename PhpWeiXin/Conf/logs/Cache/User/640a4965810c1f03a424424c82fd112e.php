...
<div class="content">
    ...
    <div class="cLineB">
        <h4 class="left">
            <?php echo ($thisCard["cardname"]); ?>
            消费记录
        </h4>
        <a class="right btnGrayS vm" href="<?php echo U('Member_card/members',array('token'=>$token,'id'=>$thisCard['id']));?>">返回</a>
        <div class="clr"></div>
    </div>
    <div class="msgWrap">
        ...
        <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tbody>
                <tr></tr>
                <?php if(is_array($coupons)): $i = 0; $__LIST__ = $coupons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$coupons): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($coupons["title"]); ?></td>
                        <td><?php echo ($coupons["coupon_num"]); ?></td>
                        <td><?php echo (date('Y-m-d',$coupons["add_time"])); ?></td>
                        <td><?php echo (date('Y-m-d',$coupons["use_time"])); ?></td>
                        <td><?php echo (date('Y-m-d',$coupons["over_time"])); ?></td>
        ...
        <div style="margin:10px 0;height:30px;line-height:30px;">
            ...
            <div class="right">
                ...
                <a href="?g=User&amp;m=Member_card&amp;a=exportCardUseRecord&wecha_id=<?php echo ($wecha_id); ?>" class="btnGrayS vm">导出积分、线下消费记录</a>
        ...
        <div style="margin:10px 0;height:30px;line-height:30px;">
            ...
            <div class="right">
                ...
                <a href="?g=User&amp;m=Member_card&amp;a=exportrmb&wecha_id=<?php echo ($wecha_id); ?>" class="btnGrayS vm">导出会员卡消费记录</a>
