	...
	public function operate()
	{
		...
		case 'fahuo':
			...
			if ($state == 0) {
				...
				$model->sendTempMsg('TM00820', array('href' => U('Bargain/myorder', array('token' => $this->token, 'type' => 1, 'wecha_id' => $order['wecha_id'], 'first' => '您的订单' . $orderid . '已发货', 'keynote1' => '已发货', 'keynote2' => date('Y年m月d日H时i分s秒'), 'remark' => '您在微砍价中购买的订单' . $orderid . '已发货'))));
			}
