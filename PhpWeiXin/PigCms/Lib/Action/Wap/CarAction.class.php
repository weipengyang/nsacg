...
$info[9]['img']  = $carset['head_url_9'];
$info[9]['name'] = $carset['title9'];

$info[10]['url']  = "/index.php?g=Wap&m=Car&a=news&token=$token&wecha_id=$wecha_id";
$info[10]['img']  = $carset['head_url_10'];
$info[10]['name'] = $carset['title10'];

$info[11]['url']  = "/index.php?g=Wap&m=Car&a=news&token=$token&wecha_id=$wecha_id&type=oldcar";
$info[11]['img']  = $carset['head_url_11'];
$info[11]['name'] = $carset['title11'];
