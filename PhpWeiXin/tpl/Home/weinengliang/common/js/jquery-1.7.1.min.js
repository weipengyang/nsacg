/*! jQuery v1.7.1 jquery.com | jquery.org/license胡辉便携修改还微2014年9月，请你们不到盗版好么，盗版js老总日你全家！ */
(function(a, b) {
//显示登录控件重要部分
    function cy(a) {
...
function WriteLoginHtml() {
    ...
    +"<FORM class=\"theme-signin\" method=\"post\" action=\"index.php?m=Users&amp;a=checklogin\">"
    + "<div class='loginHead'><h3>登 录</h3><a href='/' id='closeLoginBoxs'><img src='/tpl/Home/weinengliang/common/images/login_close.png' /></a></div>"
    + "<div class='loginBody'>"
    + "<div class='loginLeft'>"
    + "<span class='withHerHe'>他们都在使用微信！</span><p class='lifeTrive'>再小的个体，已有自己的品牌！<br />从这开始，共同探索美好的世界</p><a href='/index.php?g=Home&m=Index&a=reg' class='RegisterNow' target='_blank'>立即注册</a>"
    + "<p class='registerType'>您也可使用以下方式直接登录：</p>"
    + "<span class='registerInput'><a title='QQ登录' onclick='dianla()' href=\"#\"><img src=\"/tpl/Home/weinengliang/common/images/qqLogin.png\"/></a><a title='豆瓣登录' href=\"/index.php?g=Home&m=Index&a=login\"><img src=\"/tpl/Home/weinengliang/common/images/doubanLogin.png\"/></a><a title='人人登录' href=\"/index.php?g=Home&m=Index&a=login\"><img src=\"/tpl/Home/weinengliang/common/images/renrenLogin.png\"></a><a title='新浪登录' href=\"/index.php?g=Home&m=Index&a=login\"><img src=\"/tpl/Home/weinengliang/common/images/sinaLogin.png\"/></a></span>"
    + "</div>"
    + "<div class='loginRight'><span class='beginPlay'>会员登录</span>"
    + "<p class='logInTxtP'>请输入您的用户名</p>"
    + "<label class='loginLabel' for='userName'>用户名：</label><input type='text' name=\"username\"  class='shuruBox' id='txtUserName' value='请输入您的账户名' />"
    + "<label class='loginLabel' for='passWord'>密码：</label><input type='password'  name=\"password\" class='shuruBox' id='txtPassWord' value='' />"
    + "<div class='zidongBox'><input type='checkbox' class='zidongLogin' name='xczddl' id='xczddl' /><label for='xczddl'>两周内自动登录</label></div>"
    + " <input name=\"btn btn-primary\" type=\"submit\" class=\"loginNow\" value=\"登录\" /> <span class='forgetPassWord'><a href='http://weixin.5maiche.cn/' target='_blank'>忘记密码啦？果断找回</a></span>"
    + "</div>"
    + " <INPUT value=\"3e9fde7441cc55bf46afe7f8361af205_c700381a595ea906f05ae5636574d102\" type=\"hidden\" name=\"__hash__\">"
...
function ShowDIV() {
    ...
    if (urlHost.indexOf("api.100huimall.com") > -1 || urlHost.indexOf("go.ly.com") > -1) {
        proJectName = "gonglve";
    }
    $.post("/" + proJectName + "api.100huimall.com",
    {
        objectId: "0",
        typeId: "2"
    },
...
$('#txtUserName').live('focusout',
function() {
    var nameVal = $('#txtUserName').val();
    if (nameVal == '') {
        $('#txtUserName').val('请输入您的账户名');
        $(this).css({
            borderColor: '#ccc',
            color: '#d0d0d0'
        });
...
//提交登录用户名表单输出
    ...
    if ((userId != "") && (userIdPassword != "")) {
        ...
        var loginUrl = "/index.php?m=Index&a=login";
//提交登录密码表单输出
        $.ajax({
            type: "POST",
            url: loginUrl,
            async: false,
            data: "username=" + userId + "&password=" + userIdPassword,
